...
//rota de Pessoas
Route::get('/adm/pessoas', 'App\Http\Controllers\PessoaFisicaController@index')->name('pessoas.index');
Route::get('/adm/pessoas/create', 'App\Http\Controllers\PessoaFisicaController@create')->name('pessoa.create');
Route::post('/pessoas/store', 'App\Http\Controllers\PessoaFisicaController@store')->name('pessoa.store');
Route::put('/pessoas/update/{id}', 'App\Http\Controllers\PessoaFisicaController@update')->name('pessoa.update');
Route::delete('/pessoas/delete/{pessoa}', 'App\Http\Controllers\PessoaFisicaController@destroy')->name('pessoa.delete');
Route::get('/pessoa/edit/{id}', 'App\Http\Controllers\PessoaFisicaController@edit')->name('pessoa.edit');
